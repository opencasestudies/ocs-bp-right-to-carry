...
AVOCADO: the title seems really long? previous titles have been mostly a few words focusing around the context (not so much the). How about something like "Influence of Multicollinearity on Measured Impact of Right-to-Carry Gun Laws"?  
...
AVOCADO: I think this is the first time use the word "multicollinearity" outside the intro and citation. Should we define it here? 
...
AVOCADO: In the table below it says "DAW" and "LM". Should "LM" be "ML"? 
...
AVOCADO: Could you add source for the screenshot above? I added the code for it, just not sure what the link is. 
...
AVOCADO: I have pulled from other case studies for many of these, but they may need to be double checked
