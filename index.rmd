...
DONOHUE_OUTPUT_TIDY <- tidy(DONOHUE_within_twoways, conf.int = 0.95)
...
```{r}
pooltest(VViol_crime_rate_1k_log ~
                        RTC_LAW +
                        White_Male_15_to_19_years +
                        White_Male_20_to_39_years +
                        Black_Male_15_to_19_years +
...
AVOCADO...this might be the same as the F reported in the larger output... but I dont know...
