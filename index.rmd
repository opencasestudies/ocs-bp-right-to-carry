...
Recall that the only difference is the number of demographic variables. The number of rows or observations is the same.
...
This requires first caclulating the correaltion values useing the `cor()` function.
